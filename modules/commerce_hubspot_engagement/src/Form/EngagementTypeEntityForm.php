...
/**
 * Class EngagementTypeEntityForm.
 *
 * @package Drupal\commerce_hubspot_engagement\Form
 */
class EngagementTypeEntityForm extends BundleEntityFormBase {
  ...
  public function form(array $form, FormStateInterface $form_state) {
    ...
    $form['label'] = [
      '#type' => 'textfield',
      '#title' => $this->t('Engagement Type'),
      '#maxlength' => 255,
      '#default_value' => $entity_type->label(),
      '#description' => $this->t('Name of the engagement type.'),
      '#required' => TRUE,
    ];
    ...
    $form['id'] = [
      ...
      '#machine_name' => [
        'exists' => '\Drupal\commerce_hubspot_engagement\Entity\EngagementType::load',
      ],
